...
public partial class GameEntity {
    ...
    public void AddDamage(System.Collections.Generic.List<Damage> newDamageList) {
        var index = GameComponentsLookup.Damage;
        var component = (DamageComponent)CreateComponent(index, typeof(DamageComponent));
        component.damageList = newDamageList;
        AddComponent(index, component);
    }

    public void ReplaceDamage(System.Collections.Generic.List<Damage> newDamageList) {
        var index = GameComponentsLookup.Damage;
        var component = (DamageComponent)CreateComponent(index, typeof(DamageComponent));
        component.damageList = newDamageList;
