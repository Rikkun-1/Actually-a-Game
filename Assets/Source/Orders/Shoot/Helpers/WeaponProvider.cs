public static class WeaponProvider
{
    ...
    {
        e.AddWeapon(0, 1.5f, 1.5f, 15, 25, 12, "Prefabs/Bullet", null);
    }

    public static void GiveRiffle(GameEntity e)
    {
        e.AddWeapon(0, 0.2f, 1f, 30, 35, 1, "Prefabs/Bullet", null);
    }

    public static void GiveSniper(GameEntity e)
    {
        e.AddWeapon(0, 2.5f, 0.25f, 100, 50, 1, "Prefabs/Bullet", null);
    }
}