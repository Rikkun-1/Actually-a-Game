...
[NodeCustomEditor(typeof(MatrixBinaryFunctionNodeBase))]
public class MatrixBinaryFunctionNodeViewBase : BaseMatrixNodeView
{
    protected new MatrixBinaryFunctionNodeBase nodeTarget;
    ...
    {
        base.Enable();
        nodeTarget = (MatrixBinaryFunctionNodeBase)target;
