...
namespace RotaryHeart.Lib.AutoComplete
{
    public class EditorAddItemWindow : EditorWindow
    {
        ...
        public static void Show(Rect position, string[] items, string[] usedItems, Action<string> onItemAdded, 
                                string separator = null, string[] ignore = null, string backText = "Select Item", bool returnFullPath = true, bool allowCustom = false)
        {
            Instance.Init(position, separator, backText, items, ignore, usedItems, onItemAdded, returnFullPath, allowCustom);
            Instance.Repaint();
        }
        
        void Init(Rect rect, string separator, string backText, string[] items, string[] ignore, string[] usedItems, Action<string> onItemAdded, bool returnFullPath, bool allowCustom)
        {
