...
namespace RotaryHeart.Lib.AutoComplete
{
    internal class AddItemWindow
    {
        ...
        class Styles : AutoCompleteTextField.GUI.IStyle
        {
        ...
        string[] m_usedItems;
        AutoCompleteTextField.GUI.IStyle m_styles;
        ...
        public void Show(Rect position, string[] items, string[] usedItems, Action<string> onItemAdded, 
                                string separator = null, string[] ignore = null, string backText = "Select Item", bool returnFullPath = true, bool allowCustom = false, AutoCompleteTextField.GUI.IStyle style = null)
        {
            Init(position, separator, backText, items, ignore, usedItems, onItemAdded, returnFullPath, allowCustom, style);
        }
        
        void Init(Rect rect, string separator, string backText, string[] items, string[] ignore, string[] usedItems, Action<string> onItemAdded, bool returnFullPath, bool allowCustom, AutoCompleteTextField.GUI.IStyle style)
        {
