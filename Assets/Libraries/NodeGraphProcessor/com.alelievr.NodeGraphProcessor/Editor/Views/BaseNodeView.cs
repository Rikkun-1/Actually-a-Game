	...
	public class BaseNodeView : NodeView
	{
		...
		protected virtual void DrawDefaultInspector(bool fromInspector = false)
		{
			...
			foreach (var field in fields)
			{
				...
				bool hasInputAttribute         = field.GetCustomAttribute(typeof(NodeInputAttribute)) != null;
				bool hasInputOrOutputAttribute = hasInputAttribute || field.GetCustomAttribute(typeof(NodeOutputAttribute)) != null;
				...
				var showInputDrawer = field.GetCustomAttribute(typeof(NodeInputAttribute)) != null && field.GetCustomAttribute(typeof(SerializeField)) != null;
				showInputDrawer |= field.GetCustomAttribute(typeof(NodeInputAttribute)) != null && field.GetCustomAttribute(typeof(ShowAsDrawer)) != null;
		...
		{
			if (field.GetCustomAttribute(typeof(NodeInputAttribute)) == null || fromInspector)
				return;
